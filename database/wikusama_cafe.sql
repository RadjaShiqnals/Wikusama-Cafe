...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2024 at 02:09 AM
...
--
ALTER TABLE `detail_transaksi`
  ADD CONSTRAINT `detail_transaksi_id_menu_foreign` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`) ON DELETE CASCADE,
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_id_meja_foreign` FOREIGN KEY (`id_meja`) REFERENCES `meja` (`id_meja`) ON DELETE CASCADE,
